    ...
    [
        ...
        False,
        {
            "args": [
                ...
                "--distributed-executor-backend",
                "mp",
                # The env below takes aiter's all-reduce out; this takes vLLM's own
                # custom one out too, leaving PYNCCL, after a degenerate reply survived it.
            ...
            "env": {
                ...
                # the spread is what decides the long-context probe.
