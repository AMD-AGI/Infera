...
本目录是 **单机 R4 serving**(实验一)。PD 分离(实验二)是独立子交付,已移至
**`../crsuse/singlenode_tp4_noNIC_loopbacktcp_dsv4_20260723/`**:节点内 1P1D PD 分离端到端跑通(smoke + 压测过 router),跨节点 wiring
全验证但卡 mooncake RDMA 内存注册。共享本目录的集群/镜像/模型,基础 GOTCHAS 也复用本目录。
...
5. `../crsuse/singlenode_tp4_noNIC_loopbacktcp_dsv4_20260723/README.md` —— (可选)PD 分离实验二。
