...
1. vultr好像有我们起好的服务，在我们已有的服务上直接运行bench, 拿到首轮结果。

## reference material

1. vultr集群infera自身agentic bench的packup（包含服务部署和测试方法）: par8.glm52.dpaoff.packup_20260803
2. CruSoe(spur)集群infera自身agentic bench的packup（包含服务部署和测试方法）: agenticbench.mtp.caseA.packup_20260801
3. 客户bench 方法和简单部署代码: https://github.com/ROCm/MAD/pull/173/changes
    1. 客户的部署方法如果不一样，请分析哪些地方值得学习，交由用户决策
4. 客户代码的本地repo: /home/yihou/dev/git.16-19/MAD
