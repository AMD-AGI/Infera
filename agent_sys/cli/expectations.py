...
def _rt_fanout_verdict(verdict: Any, handoff: Any) -> str | None:
    if verdict.validator == "check_thing" and handoff.type == "thing_b" and not verdict.result:
...
RT_FANOUT = ExpectationSet(_RT_FANOUT_PROMISES, {}, _rt_fanout_task, _rt_fanout_verdict)
...
def _rt_disagree_verdict(verdict: Any, handoff: Any) -> str | None:
    if verdict.validator == "check_agree" and handoff.type == "review" and not verdict.result:
...
RT_DISAGREE = ExpectationSet(_RT_DISAGREE_PROMISES, {}, _rt_disagree_task, _rt_disagree_verdict)
