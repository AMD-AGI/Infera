...
def test_a_stranger_answering_http_on_our_port_is_not_adopted(prefix, caplog, monkeypatch) -> None:
...
def test_a_daemon_record_for_a_dead_pid_is_not_ownership(prefix, caplog, monkeypatch) -> None:
...
def test_a_daemon_record_for_another_port_is_not_ownership(prefix, caplog, monkeypatch) -> None:
...
def test_a_health_check_timeout_is_a_warning_and_a_skip(prefix, caplog, monkeypatch) -> None:
...
def test_check_disabled_agents_runs_with_home_pointed_into_the_prefix(prefix, monkeypatch) -> None:
