...
this repository — `../fail.dangling_handoff_kind.1/` is the second directory that is structurally
...
`broken/` used to be a subdirectory here and is now `../fail.dangling_handoff_kind.1/`, a sibling
