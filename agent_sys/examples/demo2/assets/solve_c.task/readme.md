# solve_c — student C, solve your share of the problem set
...
> **You solve every problem whose index `i` satisfies `i % 3 == 2`.**

Student A takes `i % 3 == 0` and student B takes `i % 3 == 1`. Apply the rule to
...
Write into the directory named by **`$AGENT_SYS_OUTPUT_SOLUTIONS_C`**. That is
...
- **`## Purpose`** — what this handoff is: student C's solutions to their share.
