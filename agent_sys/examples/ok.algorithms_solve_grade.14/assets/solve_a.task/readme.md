# solve_a — student A, solve your share of the problem set
...
> **You solve every problem whose index `i` satisfies `i % 3 == 0`.**

Student B takes `i % 3 == 1` and student C takes `i % 3 == 2`. Apply the rule to
...
Write into the directory named by **`$AGENT_SYS_OUTPUT_SOLUTIONS_A`**. That is
...
- **`## Purpose`** — what this handoff is: student A's solutions to their share.
