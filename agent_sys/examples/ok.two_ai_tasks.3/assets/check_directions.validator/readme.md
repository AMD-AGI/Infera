...
`examples/ok.filetree_grounded_report.4/assets/check_grounded.validator/readme.md` draws about its own
`\d+`.

## What it will not tell you

Whether the chosen areas are a *good* syllabus. Whether they are the ones a
...
like a teacher who invented every one of them. *Could not check* and *checked and found
