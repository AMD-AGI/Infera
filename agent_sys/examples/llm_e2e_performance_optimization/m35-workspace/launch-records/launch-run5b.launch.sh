...
LD=/data/yihou/e2e_verify_20260906/m35/launch-run5b
env -u PYTHONPATH \
...
python3 /data/yihou/e2e_verify_20260906/m2/launch_chain.py \
  ...
  --var m1_agent=runner \
  --var m2_agent=runner \
  --var work_root=/data/yihou/e2e_flow5b \
  --var scratch_root=/data/yihou/e2e_flow5b/kfo \
  --var validate_work_root=/data/yihou/e2e_flow5b/validate \
  --var container=yihou_e2e_chain5b \
