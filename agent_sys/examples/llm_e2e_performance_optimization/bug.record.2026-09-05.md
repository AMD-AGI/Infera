...
**最后核对:2026-09-05T08:45Z**(**19 条**;第 17 条 4 个实例,其检查已改为**两趟**)。
...
| 17 | 更正落在作者当时在的地方,不在指令处 | 文档,非代码 | **四实例已修,类别未扫** |
| 18 | 从自己写过的东西的**记忆**下笔,作者身份成了不重读的理由 | 文档/流程 | **实例已修,类别未扫** |
| 19 | 向第三方指出陈值,持有人从未收到 | 流程 | **未修(最便宜的一条)** |
...
> **快查表是唯一会变陈的位置。** 正文是对的,表格是错的——**可靠地朝这一个方向**。
> 因为正文是你**发现问题时正在写的地方**,而表格是**别人最先读的地方**。
...
**观察**:m3 在一封**发给 readme-cn** 的消息里指出自己的 `:128` / `:267` 已经
陈了。**持有那两个引用的是 m4,而 m4 从头到尾不在这封消息里。**
