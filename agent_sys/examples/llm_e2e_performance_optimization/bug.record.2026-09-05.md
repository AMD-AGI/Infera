...
**最后核对:2026-09-05T09:00Z**(**19 条**;第 17 条 **5 个实例**,措辞已改为「作者在哪」;第 19 条实例已撤回)。
...
**类别(2026-09-05T08:10Z 采用 readme-cn 送出后自己收紧的版本,**原始版本更粗,
见文末)**:**

> ~~**快查表是唯一会变陈的位置。正文是对的,表格是错的。**~~
> **这句话是错的,08:55 由 readme-cn 自己推翻(它本来就是他们的原句)。**
> 正确的说法是:
>
...
(leader 说「一小时」,实测 **12m30s**;方向上让这条更狠,不是更松。)
...
#### 更正(08:45,readme-cn 指出):**不是这条检查抓到的,这条检查在这个文件上返回「干净」**
...
**readme-cn 08:55 找到,我第一手复核过 `c18d7cc` 的 diff。**
...
### ⚠ 更正(09:00):**唯一那个实例是假的。m3 直接告诉过 m4,而且已经闭环。**
