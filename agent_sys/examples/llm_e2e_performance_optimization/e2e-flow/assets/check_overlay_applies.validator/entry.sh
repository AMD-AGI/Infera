...
# `cli/main.py` exports the run's own interpreter under that name, and a
...
exec "${AGENT_SYS_DEMO_PYTHON:-python3}" "$PKG/assets/check_overlay_applies.validator/check.py" "$@"
