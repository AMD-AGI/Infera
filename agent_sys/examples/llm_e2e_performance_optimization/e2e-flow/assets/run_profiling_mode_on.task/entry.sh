...
rc=0
bash "$PKG/assets/lib/mock.sh" stage2-profiling profiling_mode_on.bench_result:aiperf_profiled profiling_mode_on.profile_result:torch_trace profiling_mode_on.kernel_table:kernel_table || rc=$?
