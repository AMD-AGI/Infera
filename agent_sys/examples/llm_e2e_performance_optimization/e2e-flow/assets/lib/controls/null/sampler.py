...
# --- m5 CONTROL OVERLAY: NULL -------------------------------------------------
# Semantically identical to the file it replaces. No optimisation is claimed and
# none was made. Present only so that the mounted bytes differ from the stock
# bytes, which is what the mount and the patch-live evidence compare.
M5_CONTROL_OVERLAY = "null"
