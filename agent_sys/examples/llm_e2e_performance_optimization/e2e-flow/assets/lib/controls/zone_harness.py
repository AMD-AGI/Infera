...
def run(
    ...
    *,
    ...
    home: str | None = None,
) -> tuple[subprocess.CompletedProcess, dict | None, str]:
    ...
    (zone / "materials.json").write_text(json.dumps({k: str(v) for k, v in materials.items()}))
...
def show(
    title: str, validator: str, materials: dict, args: dict, expect: bool | None = None, **kw
) -> bool:
