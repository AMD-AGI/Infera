...
is here because a non-leaf root is the shape `examples/ok.filetree_grounded_report.4` and
`examples/ok.algorithms_solve_grade.14` use and the shape the suite exercises, and because the day a
