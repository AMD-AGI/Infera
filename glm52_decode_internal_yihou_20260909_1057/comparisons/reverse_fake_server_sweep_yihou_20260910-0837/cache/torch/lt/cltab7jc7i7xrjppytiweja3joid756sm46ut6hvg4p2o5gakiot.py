...
# kernel path: /torch-cache/pw/cpwc42u665ldfm6iok54oo5gkvjfq2esjqop2msaqz27plgixqmn.py
...
# kernel path: /torch-cache/4s/c4ssmhghnqxx6xhnfrygpvt6zeu37aeawqt5azt75lyzvrwjaind.py
...
#   max_1 => max_1
# Graph fragment:
#   %arg6_1 : Tensor "i64[s37, 1][1, 1]cuda:3" = PlaceHolder[target=arg6_1]
#   %view_1 : Tensor "f32[s0, 1][1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_3, [%arg3_1, 1]), kwargs = {})
#   %max_1 : [num_users=2] = call_function[target=torch.ops.aten.max.dim](args = (%view_1, -1, True), kwargs = {})
#   %gather : Tensor "i64[s0, 1][1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.gather.default](args = (%arg6_1, 1, %getitem_1), kwargs = {})
#   return %gather
...
# kernel path: /torch-cache/x7/cx7clunysajc22rbtjrm3syko6kavzi44l5nwvizfguxgffw5i2s.py
...
# Graph fragment:
#   %arg8_1 : Tensor "bf16[s0, s87][s87, 1]cuda:3" = PlaceHolder[target=arg8_1]
#   %view_1 : Tensor "f32[s0, 1][1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_3, [%arg3_1, 1]), kwargs = {})
#   %max_1 : [num_users=2] = call_function[target=torch.ops.aten.max.dim](args = (%view_1, -1, True), kwargs = {})
...
#   %index : Tensor "bf16[s0, s87][s87, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg8_1, [%add_47]), kwargs = {})
#   return %index
...
# kernel path: /torch-cache/qs/cqsumw43osyoyvdzeltx2agre2spm2kfg3tdovvwg7jnkxyc2sif.py
...
#   %view_1 : Tensor "f32[s0, 1][1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_3, [%arg3_1, 1]), kwargs = {})
#   %max_1 : [num_users=2] = call_function[target=torch.ops.aten.max.dim](args = (%view_1, -1, True), kwargs = {})
#   %add_53 : Tensor "i64[s0, 1][1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_1, %arg9_1), kwargs = {})
#   return %add_53
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(3):
            ...
            # Topologically Sorted Source Nodes: [flatten, max_1, gather], Original ATen: [aten.view, aten.max, aten.gather]
            stream3 = get_raw_stream(3)
            triton_poi_fused_gather_max_view_1.run(arg6_1, buf2, s0, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused_add_arange_floor_divide_index_max_unsqueeze_view_2.run(arg8_1, buf3, triton_poi_fused_add_arange_floor_divide_index_max_unsqueeze_view_2_xnumel, stream=stream3)
            del arg8_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 1
    arg1_1 = 8
    arg2_1 = rand_strided((8, 1), (1, 1), device='cuda:3', dtype=torch.float32)
    arg3_1 = 8
    arg4_1 = rand_strided((8, 1), (1, 1), device='cuda:3', dtype=torch.float32)
    arg5_1 = 8
    arg6_1 = rand_strided((8, 1), (1, 1), device='cuda:3', dtype=torch.int64)
    arg7_1 = 6144
    arg8_1 = rand_strided((8, 6144), (6144, 1), device='cuda:3', dtype=torch.bfloat16)
    arg9_1 = 1
