...
# kernel path: /torch-cache/ak/cakfv7uqustkrm2zyfrvssy2xz7qkb5xmm56inoak6bgg463ghvd.py
...
#   weights => mul_2
# Graph fragment:
#   %gemm_a16w16_default : Tensor "bf16[s77, 32][32, 1]cuda:0" = PlaceHolder[target=gemm_a16w16_default]
#   %arg4_1 : Tensor "f32[s77, 32, 1][32, 1, 1]cuda:0" = PlaceHolder[target=arg4_1]
#   %arg5_1 : Tensor "f64[][]cpu" = PlaceHolder[target=arg5_1]
#   %mul_2 : Tensor "bf16[s77, 32][32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%gemm_a16w16_default, 0.1767766952966369), kwargs = {})
#   %unsqueeze : Tensor "bf16[s77, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_2, -1), kwargs = {})
#   %mul_7 : Tensor "f32[s77, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze, %arg4_1), kwargs = {})
...
#   %mul_tensor : Tensor "f32[s77, 32, 1][32, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_7, %convert_element_type_default_1), kwargs = {})
#   return %mul_tensor
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_poi_fused_mul_unsqueeze_0.run(buf3, arg4_1, arg5_1.item(), buf4, triton_poi_fused_mul_unsqueeze_0_xnumel, stream=stream0)
            del arg4_1
            del arg5_1
            del buf3
        return (buf4, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 96
    arg1_1 = 6144
    arg2_1 = rand_strided((96, 6144), (6144, 1), device='cuda:0', dtype=torch.bfloat16)
    arg3_1 = rand_strided((32, 6144), (6144, 1), device='cuda:0', dtype=torch.bfloat16)
    arg4_1 = rand_strided((96, 32, 1), (32, 1, 1), device='cuda:0', dtype=torch.float32)
