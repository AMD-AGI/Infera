...
phase=json.loads((a.root/'config/active-phase.json').read_text());prefix=phase['prefix'];image='sha256:4f125ff9096f75611fa24caad4c01c3707dd0892251680a6483b99ffaa2a88bb';events=a.root/'events'/('container-guard-'+a.role+'.jsonl');stop=False
...
while True:
 ...
 try:
  ...
  # Query failures are observation failures, not proof of allocation loss.
  if a.once:break
 if a.once:break
 time.sleep(5)
