...
# Job 31609: isolated C80 8K run; overrides follow all baseline sources.
BASELINE_RUN=/perf_apps/liyingli/bench_agentx/p8d8-tracing-aus-20260922/runs/main-20260922
TRACE_RUNTIME=/perf_apps/liyingli/bench_agentx/p8d8-chunk8k-31609-20260923
RUN_ID=chunk8k-c80-31609
RUN="$TRACE_RUNTIME/runs/$RUN_ID"
BENCH_DIR="$TRACE_RUNTIME/scripts/bench-harness"
REMOTE_BENCH_DIR="$BENCH_DIR"
TOPOLOGY="$TRACE_RUNTIME/config/topology.tsv"
CONTAINER_PREFIX=llying-aus-8k-31609
PREFILL_NODE=smci355-ccs-aus-n02-25
DECODE_NODE=smci355-ccs-aus-n04-29
PREFILL_IP=10.235.192.129
