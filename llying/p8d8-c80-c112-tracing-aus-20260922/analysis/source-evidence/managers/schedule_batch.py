...
class ScheduleBatch(ScheduleBatchDisaggregationDecodeMixin):
    ...
    # Group-wide draft-graph gate; permissive until the sync sets it.
    can_run_dp_draft_cuda_graph: bool = True
    # Rank-local request for an eager draft step; the MLP-sync all-gather turns
    # it into the group-wide gate above.
