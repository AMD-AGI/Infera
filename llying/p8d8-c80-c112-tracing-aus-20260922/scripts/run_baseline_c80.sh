...
python3 "$ROOT/scripts/validate_allocation.py"
state VALIDATING_BASELINE_CONFIG
python3 "$ROOT/scripts/validate_chunk_config.py"
state SMOKE
...
cp "$ROOT/scripts/run_baseline_c80.sh" "$ROOT/scripts/validate_smoke.py" "$RUN/snapshot/smoke-recovery/"
