#!/usr/bin/env bash
# Optimized configuration only, on job 31644 restart 3. No follow-up baseline.
source /perf_apps/liyingli/bench_agentx/p8d8-adaptive-31625-20260923/config/a0-guard-decode.sh
RUN_ID=g3-guard-completion
RUN="$TRACE_RUNTIME/runs/$RUN_ID"
BASELINE_RUN="$TRACE_RUNTIME/runs/a0-guard-decode"
PREFILL_NODE=smci355-ccs-aus-n04-29
PREFILL_IP=10.235.192.57
DECODE_NODE=smci355-ccs-aus-n04-25
DECODE_IP=10.235.192.131
CONTROL_NODE="$PREFILL_NODE"
BUILDER_NODE="$PREFILL_NODE"
TOPOLOGY="$TRACE_RUNTIME/config/topology-31644-restart2.tsv"
...
EXPECTED_PREFILL_TOKENS=3142720
EXPECTED_DECODE_TOKENS=3003264
EXPECTED_HOST_TOKENS=4714112
...
AITER_JIT_CACHE_ROOT=/tmp/aiter-jit-100078-g3
