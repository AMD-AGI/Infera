# PREPARED ONLY: run after A1 analysis decision, never concurrently.
#!/usr/bin/env bash
...
BASELINE_RUN=/perf_apps/liyingli/bench_agentx/p8d8-adaptive-31625-20260923/runs/a1-guard-decode
