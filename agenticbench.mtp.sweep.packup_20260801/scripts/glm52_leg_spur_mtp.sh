...
# verify at high concurrency. Follows MTP by default so that MTP=0 reproduces
# the kvaware/kvd baseline command line byte-for-byte; set CUSTOM_AR to override.
