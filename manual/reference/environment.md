...
| `INFERA_NATS_REQ_IDLE_TIMEOUT` | `240` (s) | Max wait for the next reply chunk; expiry → 504 + cancel. `0` = forever. |
| `INFERA_HTTP_REQ_IDLE_TIMEOUT` | `240` (s) | Same, for `--request-transport http`; expiry fails the stream. `0` = forever. |
