...
from infera.projection._vendor.projection_core.core.projection.base_module_profiler import BaseModuleProfiler
from infera.projection._vendor.projection_core.core.projection.profiler_spec import ModuleProfilerSpec
from infera.projection._vendor.projection_core.core.projection.training_config import TrainingConfig
...
class LanguageModelProfiler(BaseModuleProfiler):
    ...
    def _estimate_layer_communication(self, layer_idx: int, layer_type: str):
        ...
        """
        from infera.projection._vendor.projection_core.core.projection.module_profilers import collective_model as cm
        from infera.projection._vendor.projection_core.core.projection.module_profilers.collective_args import (
            get_default_args,
        )
