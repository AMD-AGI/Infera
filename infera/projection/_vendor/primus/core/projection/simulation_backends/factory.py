...
from infera.projection._vendor.primus.core.projection.simulation_backends.base import (
...
def get_gemm_simulation_backend(
    ...
    from infera.projection._vendor.primus.core.projection.simulation_backends.origami_backend import (
        OrigamiGEMMBackend,
    )
...
def get_sdpa_simulation_backend(
    ...
    """
    from infera.projection._vendor.primus.core.projection.simulation_backends.sdpa_simulator import SDPASimulator
