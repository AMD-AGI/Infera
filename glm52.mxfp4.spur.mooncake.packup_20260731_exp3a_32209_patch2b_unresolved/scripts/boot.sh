...
# e3a/e3b reuse the node pairs freed by e1/e2 after those arms were packed up.
# e3a round 3: the original pair (14320/14321) died NODE_FAIL 2026-07-30 12:49
# along with every other job of that era. These are freshly held nodes running
# a REBUILT infera.yihou.sglang.1.0 (the old image tar was lost when /home
# filled; rebuilt from git 9cbed1f, dma-buf self-check DMABUF_COMPILED_IN=yes).
e3a) PJOB=14915; PIP=10.245.158.72; DJOB=14914; DIP=10.245.147.58 ;;
# e3c: e3a plus #32209's _slice_draft_output_to_local_tokens. Third node pair
# of the day -- the 14914/14915 pair was lost too (see NODES.md).
e3c) PJOB=17443; PIP=10.245.152.84; DJOB=17444; DIP=10.245.151.183 ;;
e3b) PJOB=14317; PIP=10.245.152.243; DJOB=14318; DIP=10.245.155.111 ;;
