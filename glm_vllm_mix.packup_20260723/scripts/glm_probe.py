#!/usr/bin/env python3
"""temp=0 factual correctness probe for the GLM-5.1-FP8 vLLM server.

THE actual test. A 200 / ready server means NOTHING about correctness. GLM is a
THINKING model — with thinking ON and a small max_tokens the whole budget is spent
in the reasoning preamble and content looks empty/truncated (NOT wrong). So we send
