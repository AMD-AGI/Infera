...
|---|---|---|---|---|
| prefill | 14315 | `crsuse2-m2m-118` | 10.245.159.138 | 30000 |
| decode | 14316 | `crsuse2-m2m-003` | 10.245.157.171 | 30001 |

Router ran on the **prefill** node, port **8110**, prometheus **29110**.
...
Captured on `crsuse2-m2m-118`; the decode node is the same SKU.
