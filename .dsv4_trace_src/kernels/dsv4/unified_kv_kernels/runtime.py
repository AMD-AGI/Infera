...
def _naive_enabled() -> bool:
    import os

    return os.environ.get("DSV4_NAIVE_ATTN", "0") == "1"
...
def decode(
    *,
    ...
    if _naive_enabled():
        from sglang.srt.layers.attention.dsv4.unified_kv_kernels.naive_torch import (
            naive_decode,
        )
