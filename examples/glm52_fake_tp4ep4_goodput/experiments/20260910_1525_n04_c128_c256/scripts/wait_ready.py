...
a = p.parse_args()
w = Path('/apps/tas/yaoc/research/topic/infera-with-hyperloom/exp_only/Infera-yx-test/examples/glm52_fake_tp4ep4_goodput/experiments/20260910_1525_n04_c128_c256')
r = w/'rounds'/a.round
...
while time.monotonic() - start < a.seconds:
    ...
    if result.returncode == 0:
        ...
        if info is not None:
            ...
            raise SystemExit(0)
    check = subprocess.run(['spur','exec',a.job,'docker','inspect','glm52-goodput-high-20260910-1525',
