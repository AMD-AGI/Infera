#!/bin/bash
set -euo pipefail
W=/apps/tas/yaoc/research/topic/infera-with-hyperloom/exp_only/Infera-yx-test/examples/glm52_fake_tp4ep4_goodput/experiments/20260910_1540_n04_c128
MODE=${1:?mix, decode, or sim}
ROUND=${2:?round name}
MEM=${3:-0.85}
CONC=${4:-16}
NAME=glm52-goodput-c128-20260910-1540
...
CMD=(python3 -m sglang.launch_server
    ...
    --max-running-requests "$CONC" --cuda-graph-max-bs "$CONC" --cuda-graph-bs-decode 1 16 32 64 128
