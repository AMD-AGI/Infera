#!/bin/bash
set -euo pipefail
W=/apps/tas/yaoc/research/topic/infera-with-hyperloom/exp_only/Infera-yx-test/examples/glm52_fake_tp4ep4_goodput/experiments/20260910_1545_n04_c256_m084
ROUND=${1:?round name}
N=${2:-128}
CONC=${3:-16}
R="$W/rounds/$ROUND"
...
docker exec -e PYTHONPATH=/sglang/python -e PYTHONDONTWRITEBYTECODE=1 glm52-goodput-c256-20260910-m084 "${CMD[@]}"
