...
# what: bring up sglang PD (mori) across nodes by TOPO, via infera.server etcd auto-pairing.
...
BACKEND="${BACKEND:-mori}"; TOPO="${TOPO:-2p1d}"; CTR="${CTR:-dsv4_pd_sgl_mori}"; CONC="${CONC:-640}"
P2_NODE="${P2_NODE:-}"; P2_IP="${P2_IP:-}"; CASE="engine/pd_mori/sglang"
