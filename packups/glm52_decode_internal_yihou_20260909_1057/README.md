...
The launch scripts require explicit JOB_ID, NODE and CONTAINER and reject unexpected ownership/state and forbidden or peer-owned nodes. They never request or cancel allocations. Do not use nodes234/036/249. Revalidate the existing allocation before use; historical IDs are not permanent. The latest TP4/EP4 DPA sweep and its fallback qualifications are in [the sweep report](sweeps/tp4_ep4_dpa_yihou_20260910-0452/report.md).
