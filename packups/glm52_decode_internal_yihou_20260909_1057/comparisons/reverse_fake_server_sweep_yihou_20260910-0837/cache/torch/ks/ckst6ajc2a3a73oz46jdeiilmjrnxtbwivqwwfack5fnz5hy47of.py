...
#   max_1 => max_1
# Graph fragment:
#   %arg5_1 : Tensor "i64[s0, 1][1, 1]cuda:2" = PlaceHolder[target=arg5_1]
#   %view_1 : Tensor "f32[s0, 1][1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_3, [%arg3_1, 1]), kwargs = {})
#   %max_1 : [num_users=2] = call_function[target=torch.ops.aten.max.dim](args = (%view_1, -1, True), kwargs = {})
#   %gather : Tensor "i64[s0, 1][1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.gather.default](args = (%arg5_1, 1, %getitem_1), kwargs = {})
#   return %gather
...
# Graph fragment:
#   %arg7_1 : Tensor "bf16[s0, s87][s87, 1]cuda:2" = PlaceHolder[target=arg7_1]
#   %view_1 : Tensor "f32[s0, 1][1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_3, [%arg3_1, 1]), kwargs = {})
#   %max_1 : [num_users=2] = call_function[target=torch.ops.aten.max.dim](args = (%view_1, -1, True), kwargs = {})
...
#   %index : Tensor "bf16[s0, s87][s87, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg7_1, [%add_47]), kwargs = {})
#   return %index
...
#   %view_1 : Tensor "f32[s0, 1][1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_3, [%arg3_1, 1]), kwargs = {})
#   %max_1 : [num_users=2] = call_function[target=torch.ops.aten.max.dim](args = (%view_1, -1, True), kwargs = {})
#   %add_53 : Tensor "i64[s0, 1][1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_1, %arg8_1), kwargs = {})
#   return %add_53
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(2):
            ...
            # Topologically Sorted Source Nodes: [flatten, max_1, gather], Original ATen: [aten.view, aten.max, aten.gather]
            stream2 = get_raw_stream(2)
            triton_poi_fused_gather_max_view_1.run(arg5_1, buf2, s0, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused_add_arange_floor_divide_index_max_unsqueeze_view_2.run(arg7_1, buf3, triton_poi_fused_add_arange_floor_divide_index_max_unsqueeze_view_2_xnumel, stream=stream2)
            del arg7_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg3_1 = 16
    arg4_1 = rand_strided((16, 1), (1, 1), device='cuda:2', dtype=torch.float32)
    arg5_1 = rand_strided((16, 1), (1, 1), device='cuda:2', dtype=torch.int64)
    arg6_1 = 6144
    arg7_1 = rand_strided((16, 6144), (6144, 1), device='cuda:2', dtype=torch.bfloat16)
    arg8_1 = 2
