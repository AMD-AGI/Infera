...
# kernel path: /torch-cache/5e/c5ezlkswsp36qaaw6toaqx2b72enzlind5tn64ouzh6vwwx4bigb.py
...
# kernel path: /torch-cache/26/c26pqg6fbbptm5lfi5qqiwej3fkosvyyxvnztshoqq5zljxvxzx3.py
...
#   max_1 => max_1
# Graph fragment:
#   %arg6_1 : Tensor "i64[s37, 1][1, 1]cuda:1" = PlaceHolder[target=arg6_1]
#   %view_1 : Tensor "f32[s0, 1][1, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_3, [%arg3_1, 1]), kwargs = {})
#   %max_1 : [num_users=2] = call_function[target=torch.ops.aten.max.dim](args = (%view_1, -1, True), kwargs = {})
#   %gather : Tensor "i64[s0, 1][1, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.gather.default](args = (%arg6_1, 1, %getitem_1), kwargs = {})
#   return %gather
...
# kernel path: /torch-cache/jj/cjjptiec5u6g7zw3ij36yvbwgy4qn5ldko43e6qxw4dcl7v7ksd7.py
...
# Graph fragment:
#   %arg8_1 : Tensor "bf16[s0, s87][s87, 1]cuda:1" = PlaceHolder[target=arg8_1]
#   %view_1 : Tensor "f32[s0, 1][1, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_3, [%arg3_1, 1]), kwargs = {})
#   %max_1 : [num_users=2] = call_function[target=torch.ops.aten.max.dim](args = (%view_1, -1, True), kwargs = {})
...
#   %index : Tensor "bf16[s0, s87][s87, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%arg8_1, [%add_47]), kwargs = {})
#   return %index
...
# kernel path: /torch-cache/2h/c2h35krnr7lv7gv5flhjsmwgpuvejlgswsytg2ghn5vstvf6tapa.py
...
#   %view_1 : Tensor "f32[s0, 1][1, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_3, [%arg3_1, 1]), kwargs = {})
#   %max_1 : [num_users=2] = call_function[target=torch.ops.aten.max.dim](args = (%view_1, -1, True), kwargs = {})
#   %add_53 : Tensor "i64[s0, 1][1, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_1, %arg9_1), kwargs = {})
#   return %add_53
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(1):
            ...
            # Topologically Sorted Source Nodes: [flatten, max_1, gather], Original ATen: [aten.view, aten.max, aten.gather]
            stream1 = get_raw_stream(1)
            triton_poi_fused_gather_max_view_1.run(arg6_1, buf2, s0, stream=stream1)
            ...
            stream1 = get_raw_stream(1)
            triton_poi_fused_add_arange_floor_divide_index_max_unsqueeze_view_2.run(arg8_1, buf3, triton_poi_fused_add_arange_floor_divide_index_max_unsqueeze_view_2_xnumel, stream=stream1)
            del arg8_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg3_1 = 8
    arg4_1 = rand_strided((8, 1), (1, 1), device='cuda:1', dtype=torch.float32)
    arg5_1 = 8
    arg6_1 = rand_strided((8, 1), (1, 1), device='cuda:1', dtype=torch.int64)
    arg7_1 = 6144
    arg8_1 = rand_strided((8, 6144), (6144, 1), device='cuda:1', dtype=torch.bfloat16)
    arg9_1 = 1
