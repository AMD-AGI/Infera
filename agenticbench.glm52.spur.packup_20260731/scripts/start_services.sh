...
# From pr.final/scripts/kvaware_start_{prefill,decode}.sh, spur-shaped.
#
...
# form exits and takes the child with it -- no process, no log, no error. That
# cost two debugging rounds in the kvaware kit.
